...
partial class HYJ_Player
{
    ...
    {
        public int Basic_level;   // 레벨
        public int Basic_exp;     // 경험치

        public int Basic_hp;      // 현재 남은 체력
        public int Basic_hpMax;   // 최대 체력

        public int Basic_gold;    // 보유하고 있는 금화
...
public class HYJ_Player_Unit_Datas
{
    ...
    //////////  Method          //////////
    // 실제로는 비어있으나 채워져 있는 경우를 위해 별도로 처리하는 메서드.
